...
- [x] 대외 문서 검사 2종(§8·§9) + 스캐폴드 버전 스탬프 (BACKLOG-004, DEC-017~019) — 완료: 2026-08-07
...
| BACKLOG-004 | 대외 문서 검사 2종(§8 README 버전·§9 필수 문서) + 스캐폴드 버전 스탬프 | ✅ 완료(2026-08-07) | `2026-08-07-doc-checks-and-scaffold-version-design.md` · §8~§10 테스트 11건 통과 · mobius4 사고 재현 검증 |
